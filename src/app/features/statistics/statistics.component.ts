...
@Component({
  ...
  standalone: true,
  imports: [RouterLink, MatButtonModule, MatIconModule, MatTooltipModule, StatsPanelComponent, TradeLogComponent, BacktestChartComponent, HistorySidebarComponent],
